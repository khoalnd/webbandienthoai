											...
											<?php foreach ($list as $val):
												...
												<tr>
													...
													<td class="text-center">
														...
														<!-- /Xóa -->
														<a class="btn btn-info bg-olive btn-xs" href="<?php echo base_url() ?>admin/orders/trash/<?php echo $val['id'] ?>"  onclick="return confirm('Xác nhận lưu đơn hàng này ?')" role = "button">
